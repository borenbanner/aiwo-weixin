...
<!-- 				</li> -->
						...
						<div class="col-md-12">
							...
							<div class="widget wgreen">
								...
								<div class="widget-content">
									<div class="padd">
										<!-- Form starts.  -->
										<form class="form-horizontal"  action="../productServlet?method=update"
											method="post" enctype="multipart/form-data" accept-charset="utf-8">
		
											<div class="form-group">
												<label class="col-lg-4 control-label">产品名称</label>
												<div class="col-lg-6">
													<input type="hidden" name="proId" value="${productsigel.proId}"/>
													<input type="text" class="form-control" name="proName"
														placeholder="请输入产品名称" value="${productsigel.proName }">
												</div>
												...
												<div class="col-lg-6">
													<div class="input-group">
														<span class="input-group-addon">$</span> <input
															type="text" class="form-control" name="proPrice" value="${productsigel.proPrice }"> <span
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<div class="input-group">
														<input type="file" name="image"/>${productsigel.proImage }
													</div>
												</div>
											</div>

											<div class="form-group">
												<label class="col-lg-4 control-label">详细介绍</label>
												<div class="col-lg-10">
													<textarea id="editor" name="proDetail">${productsigel.proDetail }</textarea>
												</div>
											</div>
											<hr />
											<div class="form-group">
	...
	<script type="text/javascript" src="release/ueditor.all.min.js">
