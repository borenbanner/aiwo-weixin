		...
		<div class="mainbar">
			...
			<div class="page-head">
				...
				<div class="bread-crumb pull-right">
					...
					<!-- Divider -->
					<span class="divider">/</span> <a href="news.jsp"
						class="bread-current">最新咨询</a>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="widget wgreen">
								...
								<div class="widget-content">
									<div class="padd">
										<!-- Form starts.  -->
										<form class="form-horizontal"  action="../newServlet?news=update"
											method="post" enctype="multipart/form-data" accept-charset="utf-8">
		
											<div class="form-group">
												<label class="col-lg-4 control-label">标题</label>
												<div class="col-lg-6">
													<input type="hidden" name="newId" value="${newSingle.newId}"/>
													<input type="text" class="form-control" name="newTitle"
														placeholder="请输入产品名称" value="${newSingle.newTitle }">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<div class="input-group">
														<input type="file" name="image"/>${newSingle.newImage }
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-10">
													<textarea id="editor" name="newContent">${newSingle.newContent }</textarea>
												</div>
											</div>
											<hr />
											<div class="form-group">
