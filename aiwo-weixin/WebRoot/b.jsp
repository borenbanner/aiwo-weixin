...
<script type="text/javascript">
		...
		var  id = $.getUrlParam('newId');
			...
			$.ajax({
				...
				url : "newServlet",
				dataType : "json",
				data:{"news":"querysigle","newId":id},
				success : function(data) {
					var obj = data ;
					$("#titlname").text(obj.newTitle) ;
					$("#post-date").text(obj.newTime.substring(0,10));
					var ht = "<img src=\""+obj.newImage+"\" class=\"rich_media_thumb\" >";
					$("#media").empty().append(ht);
					$("#js_content").empty().append(obj.newContent);
				}
			});
		});
	</script>
