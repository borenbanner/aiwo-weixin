...
import com.aiwo.pojo.WeixinGroup;
...
public class AdvancedUtil {
	 ...
	 * @return
	 */
	// public static String makeImageCustomMessage(String openId, String
	// mediaId) {
	// String jsonMsg =
	...
	// mediaId) {
	// String jsonMsg =
	// "{\"touser\":\"%s\",\"msgtype\":\"voice\",\"voice\":{\"media_id\":\"%s\"}}";
	// return String.format(jsonMsg, openId, mediaId);
	// }
	 ...
	 * @return
	 */
	// public static String makeVideoCustomMessage(String openId, String
	// mediaId,
	// String thumbMediaId) {
	// String jsonMsg =
	 ...
	 * @return true | false
	 */
	// public static boolean sendCustomMessage(String accessToken, String
	// jsonMsg) {
